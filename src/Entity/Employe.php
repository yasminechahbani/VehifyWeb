...
class Employe
{
    ...
    public function __construct()
    {
        ...
        $this->permiss = new ArrayCollection();
    }
     ...
     */
    public function getPermiss(): Collection
    {
        return $this->permiss;
    }

    public function addPermiss(Permis $permiss): static
    {
        if (!$this->permiss->contains($permiss)) {
            $this->permiss->add($permiss);
            $permiss->setIdEmploye($this);
        }

        return $this;
    }

    public function removePermiss(Permis $permiss): static
    {
        if ($this->permiss->removeElement($permiss)) {
            // set the owning side to null (unless already changed)
            if ($permiss->getIdEmploye() === $this) {
                $permiss->setIdEmploye(null);
            }
        }
