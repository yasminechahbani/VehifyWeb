        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                ...
                if ($form->get('date_delivrance')->isSubmitted()) {
                    ...
                    // Add 10 years to delivery date for expiration
                    $expirationDate = clone $permis->getDateDelivrance();
                    $expirationDate->modify('+10 years');
                    $permis->setDateExpiration($expirationDate);
                }
                ...
                $this->addFlash('error', 'Une erreur est survenue lors de la mise à jour du permis');
            }
        }
