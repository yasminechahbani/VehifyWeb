...
class __TwigTemplate_5bb49ed39c68afbd90c9569243ced298 extends Template
{
        ...
        <div class=\"card-body text-center\">
            ...
            yield "</div>
                    ...
                    <div class=\"license-status mt-3\">
                        <span class=\"badge bg-";
            // line 29
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["permi"], "isRenewal", [], "any", false, false, false, 29)) ? ("warning") : ((((CoreExtension::getAttribute($this->env, $this->source, $context["permi"], "etat", [], "any", false, false, false, 29) == "Active")) ? ("success") : ("danger"))));
            yield " px-3 py-2\">
                            ";
            // line 30
            if (CoreExtension::getAttribute($this->env, $this->source, $context["permi"], "isRenewal", [], "any", false, false, false, 30)) {
                // line 31
                yield "                                En attente de renouvellement
                            ";
            } else {
                // line 33
                yield "                                ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["permi"], "etat", [], "any", false, false, false, 33), "html", null, true);
                yield "
                            ";
            }
            // line 35
...
";
    ...
    {
        return array (  185 => 49,  176 => 45,  162 => 35,  156 => 33,  152 => 31,  150 => 30,  146 => 29,  140 => 26,  136 => 25,  130 => 22,  125 => 20,  114 => 12,  111 => 11,  106 => 10,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "employe_front/pending_renewals.html.twig", "C:\\Users\\motez\\OneDrive\\Bureau\\template-master - Copie\\template-master - Copie\\templates\\employe_front\\pending_renewals.html.twig");
    }
}
