...
class __TwigTemplate_88bb25f57346c933bcaa15cfb145e961 extends Template
{
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_equipement_delete', {'idEquipement': equipement.idEquipement}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ equipement.idEquipement) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "equipement/_delete_form.html.twig", "C:\\Users\\motez\\OneDrive\\Bureau\\template-master - Copie\\template-master - Copie\\templates\\equipement\\_delete_form.html.twig");
    }
}
