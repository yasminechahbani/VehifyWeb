...
class __TwigTemplate_d37dbdfe514ea725d8b6b07551f012cf extends Template
{
...
<form method=\"post\" action=\"{{ path('app_reservation_delete', {'id_reservation': reservation.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ reservation.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "reservation/_delete_form.html.twig", "C:\\Users\\motez\\OneDrive\\Bureau\\template-master - Copie\\template-master - Copie\\templates\\reservation\\_delete_form.html.twig");
    }
}
