...
class __TwigTemplate_81d109fa05bda90fec7606db8d60643c extends Template
{
        ...
        yield "</h6>
                        ...
                        <div class=\"col-md-6\">
                            <div class=\"info-card bg-light p-3 rounded-3\">
                                ...
                                <h6 class=\"mb-0\">";
        // line 58
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["carte_grise"]) || array_key_exists("carte_grise", $context) ? $context["carte_grise"] : (function () { throw new RuntimeError('Variable "carte_grise" does not exist.', 58, $this->source); })()), "dateEmission", [], "any", false, false, false, 58)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, (isset($context["carte_grise"]) || array_key_exists("carte_grise", $context) ? $context["carte_grise"] : (function () { throw new RuntimeError('Variable "carte_grise" does not exist.', 58, $this->source); })()), "dateEmission", [], "any", false, false, false, 58), "d/m/Y"), "html", null, true)) : ("Non spécifiée"));
        yield "</h6>
                            </div>
                        </div>
                        ...
                        <div class=\"col-md-6\">
                            <div class=\"info-card bg-light p-3 rounded-3\">
                                ...
                                <h6 class=\"mb-0\">";
        // line 68
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["carte_grise"]) || array_key_exists("carte_grise", $context) ? $context["carte_grise"] : (function () { throw new RuntimeError('Variable "carte_grise" does not exist.', 68, $this->source); })()), "dateExpiration", [], "any", false, false, false, 68)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, (isset($context["carte_grise"]) || array_key_exists("carte_grise", $context) ? $context["carte_grise"] : (function () { throw new RuntimeError('Variable "carte_grise" does not exist.', 68, $this->source); })()), "dateExpiration", [], "any", false, false, false, 68), "d/m/Y"), "html", null, true)) : ("Non spécifiée"));
        yield "</h6>
                            </div>
                        </div>
                    </div>
...
";
    ...
    {
        return array (  197 => 78,  190 => 74,  181 => 68,  168 => 58,  155 => 48,  142 => 38,  129 => 28,  115 => 17,  103 => 7,  90 => 6,  67 => 4,  56 => 1,  54 => 2,  41 => 1,);
    }
                    ...
                    <div class=\"row g-4\">
                        ...
                        <div class=\"col-md-6\">
                            <div class=\"info-card bg-light p-3 rounded-3\">
                                ...
                                <h6 class=\"mb-0\">{{ carte_grise.dateExpiration ? carte_grise.dateExpiration|date('d/m/Y') : 'Non spécifiée' }}</h6>
                            </div>
                        </div>
                    </div>
...
{% endblock %}
", "carte_grise/show.html.twig", "C:\\Users\\user\\Videos\\template-master - Copie\\templates\\carte_grise\\show.html.twig");
    }
}
