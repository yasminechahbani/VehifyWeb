...
class __TwigTemplate_bc0adff4661af589a5dd9755497f39c0 extends Template
{
...
<body>
    ...
    <nav class=\"navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0\">
        ...
        if ((((array_key_exists("active_page", $context)) ? (Twig\Extension\CoreExtension::default(($context["active_page"] ?? null), "")) : ("")) == "home")) {
            yield "active";
        }
        yield "\">Home</a>
        ...
        yield "\" class=\"dropdown-item\">Passer Quiz</a>
                        ";
        // line 60
        if (( !(null === ($context["permis"] ?? null)) && (CoreExtension::getAttribute($this->env, $this->source, ($context["permis"] ?? null), "etat", [], "any", false, false, false, 60) == "Expired"))) {
            // line 61
            yield "    ";
            if ( !CoreExtension::getAttribute($this->env, $this->source, ($context["permis"] ?? null), "isRenewal", [], "any", false, false, false, 61)) {
                // line 62
                yield "        <a href=\"";
...
";
        ...
        yield "\">Contact</a>
            ...
            <div class=\"dropdown me-4\">
                <a href=\"#\" class=\"dropdown-toggle d-flex align-items-center text-decoration-none\" id=\"dropdownUser\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
                    ";
        // line 94
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 94), "get", ["image"], "method", false, false, false, 94)) {
            // line 95
            yield "                        <img src=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 95), "get", ["image"], "method", false, false, false, 95), "html", null, true);
        ...
        yield "                    <span class=\"d-none d-lg-inline\">
                        ";
        // line 100
        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 100), "get", ["nom"], "method", false, false, false, 100) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 100), "get", ["prenom"], "method", false, false, false, 100))) {
            // line 101
            yield "                            ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 101), "get", ["nom"], "method", false, false, false, 101), "html", null, true);
            yield " ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 101), "get", ["prenom"], "method", false, false, false, 101), "html", null, true);
            yield "
                        ";
        } else {
            // line 103
        ...
        // line 108
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 108), "get", ["email"], "method", false, false, false, 108), "html", null, true);
        yield "</a></li>
                    <li><a class=\"dropdown-item\" href=\"";
        // line 109
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_editProfile", ["id" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 109), "get", ["id"], "method", false, false, false, 109)]), "html", null, true);
   ...
   ";
    ...
    {
        return array (  374 => 166,  367 => 165,  357 => 118,  347 => 34,  336 => 6,  329 => 168,  327 => 165,  322 => 163,  318 => 162,  314 => 161,  310 => 160,  267 => 119,  265 => 118,  255 => 111,  250 => 109,  246 => 108,  241 => 105,  237 => 103,  229 => 101,  227 => 100,  224 => 99,  218 => 97,  212 => 95,  210 => 94,  193 => 84,  187 => 81,  183 => 80,  172 => 71,  168 => 69,  163 => 66,  155 => 62,  152 => 61,  150 => 60,  146 => 59,  137 => 53,  133 => 52,  120 => 46,  111 => 40,  104 => 35,  102 => 34,  97 => 32,  91 => 29,  85 => 26,  81 => 25,  77 => 24,  62 => 12,  53 => 6,  46 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "baseFhomePage.html.twig", "C:\\Users\\user\\Videos\\template-master - Copie\\templates\\baseFhomePage.html.twig");
    }
}
