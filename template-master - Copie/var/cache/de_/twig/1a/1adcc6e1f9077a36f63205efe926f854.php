...
class __TwigTemplate_2783b66abb865d24e9a5e972f26a117a extends Template
{
    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["employe"]) {
            ...
            yield "</td>
                                        <td>";
            // line 54
            ((CoreExtension::getAttribute($this->env, $this->source, $context["employe"], "idService", [], "any", false, false, false, 54)) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["employe"], "idService", [], "any", false, false, false, 54), "nom", [], "any", false, false, false, 54), "html", null, true)) : (yield "N/A"));
            yield "</td>
                                        <td>
...
";
    ...
    {
        return array (  277 => 110,  259 => 96,  236 => 95,  221 => 82,  210 => 76,  196 => 67,  188 => 62,  177 => 54,  173 => 53,  169 => 52,  165 => 51,  161 => 50,  155 => 49,  152 => 48,  147 => 47,  112 => 15,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
