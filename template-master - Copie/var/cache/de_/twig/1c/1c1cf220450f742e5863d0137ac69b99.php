...
class __TwigTemplate_e677cbb41b69d2c378daa56801b75b7c extends Template
{
    ...
    <div class=\"row\">
        ...
        <div class=\"col-lg-4\">
            ...
            <div class=\"card border-0 shadow-sm\">
                ...
                <div class=\"card-body\">
                    <div class=\"d-grid gap-2\">
                        <a href=\"{{ path('app_edit_permisOne', {'id_permis': permi.numeroPermis}) }}\" class=\"btn btn-warning\">
                            <i class=\"fas fa-edit me-2\"></i>Modifier le permis
                        </a>
                        <button type=\"button\" class=\"btn btn-info\">
                            <i class=\"fas fa-print me-2\"></i>Imprimer les détails
