 ...
 */
final class Version20250403173035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipement CHANGE id_equipement id_equipement INT NOT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE id_employe id_employe INT DEFAULT NULL');
        $this->addSql('ALTER TABLE equipement ADD CONSTRAINT FK_B8B4C6F3E8BDB84B FOREIGN KEY (id_employe) REFERENCES employe (id_employe) ON DELETE CASCADE');
        $this->addSql('CREATE INDEX IDX_B8B4C6F3E8BDB84B ON equipement (id_employe)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD CONSTRAINT FK_F804D3B93F0033A2 FOREIGN KEY (id_service) REFERENCES service (id_service) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE equipement DROP FOREIGN KEY FK_B8B4C6F3E8BDB84B');
        $this->addSql('DROP INDEX IDX_B8B4C6F3E8BDB84B ON equipement');
        $this->addSql('ALTER TABLE equipement CHANGE id_equipement id_equipement INT AUTO_INCREMENT NOT NULL, CHANGE description description TEXT DEFAULT NULL, CHANGE id_employe id_employe INT DEFAULT NULL');
