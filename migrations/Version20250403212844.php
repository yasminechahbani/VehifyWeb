 ...
 */
final class Version20250403212844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipement CHANGE id_equipement id_equipement INT NOT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE id_employe employe_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE equipement ADD CONSTRAINT FK_B8B4C6F31B65292 FOREIGN KEY (employe_id) REFERENCES employe (idEmploye) ON DELETE CASCADE');
        $this->addSql('CREATE INDEX IDX_B8B4C6F31B65292 ON equipement (employe_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B8B4C6F31B65292 ON equipement');
        $this->addSql('ALTER TABLE equipement CHANGE id_equipement id_equipement INT AUTO_INCREMENT NOT NULL, CHANGE description description TEXT DEFAULT NULL, CHANGE employe_id id_employe INT DEFAULT NULL');
