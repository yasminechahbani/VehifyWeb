 ...
 */
final class Version20250403211950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipement CHANGE id_equipement id_equipement INT NOT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE id_employe idEmploye INT DEFAULT NULL');
        $this->addSql('ALTER TABLE equipement ADD CONSTRAINT FK_B8B4C6F3E8BDB84B FOREIGN KEY (idEmploye) REFERENCES employe (idEmploye) ON DELETE CASCADE');
        $this->addSql('CREATE INDEX IDX_B8B4C6F3E8BDB84B ON equipement (idEmploye)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipement CHANGE id_equipement id_equipement INT AUTO_INCREMENT NOT NULL, CHANGE description description TEXT DEFAULT NULL, CHANGE idEmploye id_employe INT DEFAULT NULL');
