 ...
 */
final class Version20250330142208 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paiement CHANGE id_paiement id_paiement INT NOT NULL, CHANGE montant montant DOUBLE PRECISION NOT NULL');
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C8495589697FA8 FOREIGN KEY (serviceId) REFERENCES service (id_service) ON DELETE CASCADE');
        $this->addSql('DROP INDEX id_compte ON reservation');
        $this->addSql('CREATE INDEX IDX_42C84955E9C1E78D ON reservation (id_compte)');
        $this->addSql('DROP INDEX id_vehicule ON reservation');
        $this->addSql('CREATE INDEX IDX_42C8495579F41388 ON reservation (id_vehicule)');
        $this->addSql('DROP INDEX id_permis ON reservation');
        $this->addSql('CREATE INDEX IDX_42C84955310F21BE ON reservation (id_permis)');
        $this->addSql('DROP INDEX reservation_service ON reservation');
        $this->addSql('CREATE INDEX IDX_42C8495589697FA8 ON reservation (serviceId)');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT reservation_ibfk_3 FOREIGN KEY (id_permis) REFERENCES permis (id_permis) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT reservation_ibfk_1 FOREIGN KEY (id_compte) REFERENCES compte (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT reservation_service FOREIGN KEY (serviceId) REFERENCES service (id_service)');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT reservation_ibfk_2 FOREIGN KEY (id_vehicule) REFERENCES vehicule (id_vehicule) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paiement CHANGE id_paiement id_paiement INT AUTO_INCREMENT NOT NULL, CHANGE montant montant NUMERIC(10, 2) NOT NULL');
        ...
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C8495589697FA8');
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C84955E9C1E78D');
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C8495579F41388');
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C84955310F21BE');
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C8495589697FA8');
        $this->addSql('ALTER TABLE reservation CHANGE id_reservation id_reservation INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT reservation_service FOREIGN KEY (serviceId) REFERENCES service (id_service)');
        $this->addSql('DROP INDEX idx_42c8495579f41388 ON reservation');
        $this->addSql('CREATE INDEX id_vehicule ON reservation (id_vehicule)');
        $this->addSql('DROP INDEX idx_42c84955310f21be ON reservation');
        $this->addSql('CREATE INDEX id_permis ON reservation (id_permis)');
        $this->addSql('DROP INDEX idx_42c8495589697fa8 ON reservation');
        $this->addSql('CREATE INDEX reservation_service ON reservation (serviceId)');
        $this->addSql('DROP INDEX idx_42c84955e9c1e78d ON reservation');
        $this->addSql('CREATE INDEX id_compte ON reservation (id_compte)');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955E9C1E78D FOREIGN KEY (id_compte) REFERENCES compte (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C8495579F41388 FOREIGN KEY (id_vehicule) REFERENCES vehicule (id_vehicule) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955310F21BE FOREIGN KEY (id_permis) REFERENCES permis (id_permis) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C8495589697FA8 FOREIGN KEY (serviceId) REFERENCES service (id_service) ON DELETE CASCADE');
